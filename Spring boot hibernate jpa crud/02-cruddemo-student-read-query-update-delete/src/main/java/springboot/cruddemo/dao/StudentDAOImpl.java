...
public class StudentDAOImpl implements StudentDAO {
    ...
    public List<Student> findAll() {
        ...
        // create query
        TypedQuery<Student> theQuery = entityManager.createQuery("FROM Student" ,Student.class); // firs parameter is name of the JPA Entity, NOT the name of the DATABASE TABLE
